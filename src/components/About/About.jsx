    ...
    >
      ...
      >
        ...
        <div className="flex flex-col space-y-2 md:space-y-0 md:flex-row md:justify-between md:space-x-2 z-10">
          {/* Row 1 Column 1: Text */}
          <div className="bg-black w-full md:w-[56.58%] h-[185px] md:h-[398px] rounded-[16px] md:rounded-[40px] p-2 md:pl-14">
          ...
          <div className="bg-black w-full md:w-[42.61%] md:h-[398px] rounded-[16px] md:rounded-[40px] p-2 md:p-4 flex items-center justify-center">
            <img
